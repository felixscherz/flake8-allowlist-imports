# release process as used by the tox project
# https://github.com/tox-dev/tox/blob/9c596946f82cf962f744dce9d6510c4940e52122/tasks/release.py
...
if __name__ == "__main__":
    ...
    raise SystemExit(main(options.version))
